...
module.exports = {
  ...
  module: {
    rules: [{
      ...
      //   }
      // }]
      use: isProduction ? ['ng-router-loader', 'awesome-typescript-loader', 'angular2-template-loader'] : ['ng-router-loader', 'awesome-typescript-loader', 'angular2-template-loader', {
        loader: 'angular-hot-reload-loader',
        options: {
          rootModule: path.join(appPath, './app/app.module#AppModule')
        }
